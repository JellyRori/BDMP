    ...
    function MostrarDestacados() {
        ...
        .then(data => {
            ...
            if(data=="NoHayCursos"){
                ...
                for (var i in Jason) { 
                    $("#Destacados").append("<th id='cursos2'><div class='cursos'><img class='IMG' src='Javascript/fotosDelCursoP.php?id="
                    +Jason[i]['idCurso']+"' alt='fotoCurso'><p id="+Jason[i]['idCurso']+
                    " class='titCursos'>"+Jason[i]['nomCurso']+"</p><p class='Puntaje'>puntaje: "+Jason[i]['calificacion']+
                    "</p></div></th>");
    ...
    function MostrarMasVendidos() {
        ...
        .then(data => {                
            ...
            if(data=="NoHayCursos"){
                ...
                for (var i in Jason) { 
                    $("#Vendidos").append("<th id='cursos'><div class='cursos'><img class='IMG' src='Javascript/fotosDelCursoP.php?id="+Jason[i]['idCurso']+"' alt='fotoCurso' height='130' width='215'><p id="+Jason[i]['idCurso']+" class='titCursos' >"+Jason[i]['nomCurso']+"</p><p class='niveles'>Lvls: "+Jason[i]['cantNivel']+"</p></div></th>");
